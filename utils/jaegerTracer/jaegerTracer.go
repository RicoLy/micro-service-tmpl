...
func NewJaegerTracer(serviceName, jaegerAddr string) (tracer opentracing.Tracer, closer io.Closer, err error) {
...
func JaegerClientMiddleware(tracer opentracing.Tracer) grpc.UnaryClientInterceptor {
	return func(
		...
		if parent := opentracing.SpanFromContext(ctx); parent != nil {
			...
			parentCtx, err = tracer.Extract(opentracing.TextMap, MDReaderWriter{md})
